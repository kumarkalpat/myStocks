...
interface HeaderProps {
  geminiStatus: ApiStatusType;
  finnhubStatus: ApiStatusType;
}

const Header: React.FC<HeaderProps> = ({ geminiStatus, finnhubStatus }) => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <ApiStatus serviceName="Gemini" status={geminiStatus} />
            <ApiStatus serviceName="Finnhub" status={finnhubStatus} />
          </div>
        </div>
      </div>
    </header>
